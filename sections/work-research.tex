...
\dateentry{Oct 2026 Jul 2026}{
  \textbf{Software Engineering Intern}
  \hfill Google, Dublin

  \textit{AI Transformation Enablement, User Protection Content Safety, Google Core}

    Full-stack engineering in Python, and Typescript. Improved the durability of an internal product for generating adversarial datasets for training AI models. 
}
...
\hspace{0.5em}{\tiny $\raisebox{1px}{\bullet}$}\hspace{0.2em} Duties: Creation of lecture notes, exercises, material, assignments. Conducted exercise sessions.
}
